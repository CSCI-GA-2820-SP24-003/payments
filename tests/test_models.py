...
class TestPaymentMethodModel(TestCaseBase):
    ...
    def test_set_payment_as_default(self):
    ...
    def test_unset_other_payment_methods_when_one_is_set(self):
    ...
    def test_default_status_persists(self):
    ...
    def test_find_default_payment(self):
